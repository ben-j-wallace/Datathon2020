...
```{r}
combined_recent <- merge(education_recent,pop_estimates_recent,by="Area_name")
combined_recent <- merge(combined_recent,poverty_estimates_recent,by="Area_name")
combined_recent <- merge(combined_recent,unemployment_recent,by="Area_name")
combined_recent
```
